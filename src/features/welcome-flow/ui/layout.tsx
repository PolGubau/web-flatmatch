...
export const WelcomeFlowLayout = ({ children }: PropsWithChildren) => {
	...
	return (
		<div className="md:pt-20 max-md:h-full">
			<section className="flex flex-col gap-4 h-full md:max-w-md mx-auto md:shadow-lg md:rounded-2xl bg-background overflow-hidden">
				<header
...
bg-[length:200%_200%] animate-gradient-move"
				>
					<div className="">
						<h1 className="md:text-center max-md:px-3 font-regular tracking-wide line-clamp-1 text-background/80 text-4xl pb-3 ">
							{name ? `${t("hi")} ${name}` : t("welcome")}
						</h1>
						<h2 className="md:text-center text-background/80">
