		...
		<SelectPrimitive.Portal>
			<SelectPrimitive.Content
				className={cn(
					...
					// Base
					"bg-canvas text-foreground relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-xl border-2 border-foreground/30 shadow-md",
					position === "popper" &&
